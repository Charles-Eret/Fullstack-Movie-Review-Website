//gets url of site and takes in the values needed
const url = new URL(location.href); 
const movieId = url.searchParams.get("id")
const movieTitle = url.searchParams.get("title")

const APILINK = 'https://6d830ce6-0420-404e-9231-df64226cefa2-00-3o3l09s8fz9vv.janeway.replit.dev/api/v1/reviews/';
